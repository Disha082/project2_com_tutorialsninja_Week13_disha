...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("input-payment-firstname"), "xyz");
        sendTextToElement(By.id("input-payment-lastname"), "yuth");
        sendTextToElement(By.id("input-payment-email"), "prme123@gmail.com");
        sendTextToElement(By.id("input-payment-telephone"), "154782365");
        sendTextToElement(By.id("input-payment-address-1"), "1 r long street");
        sendTextToElement(By.id("input-payment-city"), "London");
        sendTextToElement(By.id("input-payment-postcode"), "SW12 0PY");
