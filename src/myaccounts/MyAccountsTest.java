...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("input-firstname"), "ghytg");
        //3.4 Enter Last Name
        sendTextToElement(By.id("input-lastname"), "Ukiyh");
        //3.5 Enter Email
        sendTextToElement(By.id("input-email"), "xyzpqr1236@gmail.com");
        //3.6 Enter Telephone
        sendTextToElement(By.id("input-telephone"), "12547896");
        //3.7 Enter Password
        sendTextToElement(By.id("input-password"), "tofhkjf125874");
        //3.8 Enter Password Confirm
        sendTextToElement(By.id("input-confirm"), "tofhkjf125874");
